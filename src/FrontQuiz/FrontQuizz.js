...
import { questions as QUESTIONS } from "../Utilities/data";
import FrontEnd from "../Images/FrontEnd.png";
import "./FrontQuizz.css";
...
const FrontQuizz = () => {
  ...
  }, [launchQuizz, timer, exitFullscreen]);
      ...
      {FullscreenPermission && (
        <div className="quizz-container">
          <div className="Quizz-Title">
            ...
            <h1>
              The Front-End Quiz is a 10-question test on front-end web
              ...
              <div class="results-summary-container" onClick={closeResult}>
                ...
                <div class="results-summary-container__result">
                  ...
                  <div class="summary__cta">
                    <button class="btn btn__continue" onClick={closeResult}>
                      Continue
                    </button>
                  </div>
                </div>
